...
// Array de palabras
let palabras = [["whatsap", "app de mensajeria mas utilizada"],
["twiter", "app para colocar pensamientos o fraces"],
["instagram", "app mas utilizada por los famosos"],
["facebook", "app para postear fotos"],
["youtube", "app para ver videos y escuchar musica"],
["tiktok", "app de videos cortos"],
];
// Palabra a averiguar
let palabra = "";
// Nº aleatorio
...
function intento(letra) {
    ...
    if (palabra.indexOf(letra) != -1) {
        ...
        hueco.innerHTML = oculta.join("");
        document.getElementById("acierto").innerHTML = "acertaste!";
